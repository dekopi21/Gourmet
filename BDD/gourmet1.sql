...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 28 Juillet 2018 à 00:15
...
--
-- Structure de la table `commande_com_cli_plat`
--

CREATE TABLE IF NOT EXISTS `commande_com_cli_plat` (
  `commande_id` bigint(20) NOT NULL,
  `com_cli_plat_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_bg0m7bdp4h3lh8f9kv6gdyej2` (`com_cli_plat_id`),
  KEY `FK_bg0m7bdp4h3lh8f9kv6gdyej2` (`com_cli_plat_id`),
  KEY `FK_4pdntc3ua6xan7d7ctgr26e36` (`commande_id`)
...
--
-- Structure de la table `plat_com_cli_plat`
--

CREATE TABLE IF NOT EXISTS `plat_com_cli_plat` (
  `plat_id` bigint(20) NOT NULL,
  `com_cli_plat_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_6pkjgwojoqnl517hhwlhuvk11` (`com_cli_plat_id`),
  KEY `FK_6pkjgwojoqnl517hhwlhuvk11` (`com_cli_plat_id`),
  KEY `FK_1vf7kfcn650557i0dvx7g5iwi` (`plat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Structure de la table `typereglement_reglement`
--

CREATE TABLE IF NOT EXISTS `typereglement_reglement` (
  `typereglement_id` bigint(20) NOT NULL,
  `reglements_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_4sy3o3idi53oq9ko7rvy6r1ri` (`reglements_id`),
  KEY `FK_4sy3o3idi53oq9ko7rvy6r1ri` (`reglements_id`),
  KEY `FK_d4h4vqs3ylbgr4swr7d2s6bna` (`typereglement_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Structure de la table `utilisateur_com_cli_plat`
--

CREATE TABLE IF NOT EXISTS `utilisateur_com_cli_plat` (
  `Utilisateur_id` bigint(20) NOT NULL,
  `com_cli_plat_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_18dnmn86l6m0beubwp73bror2` (`com_cli_plat_id`),
  KEY `FK_18dnmn86l6m0beubwp73bror2` (`com_cli_plat_id`),
  KEY `FK_7q4i4ifdj8cqc91m8nfmdttgc` (`Utilisateur_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Structure de la table `utilisateur_livraison`
--

CREATE TABLE IF NOT EXISTS `utilisateur_livraison` (
  `Utilisateur_id` bigint(20) NOT NULL,
  `livraisons_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_mfs8qmnmbca0gltx57x3ltrev` (`livraisons_id`),
  KEY `FK_mfs8qmnmbca0gltx57x3ltrev` (`livraisons_id`),
  KEY `FK_ohj725lbbx4t6p3ar44by2s7c` (`Utilisateur_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Contraintes pour la table `commande_com_cli_plat`
--
ALTER TABLE `commande_com_cli_plat`
  ADD CONSTRAINT `FK_4pdntc3ua6xan7d7ctgr26e36` FOREIGN KEY (`commande_id`) REFERENCES `commande` (`id`),
  ADD CONSTRAINT `FK_bg0m7bdp4h3lh8f9kv6gdyej2` FOREIGN KEY (`com_cli_plat_id`) REFERENCES `com_cli_plat` (`id`);
...
--
-- Contraintes pour la table `plat_com_cli_plat`
--
ALTER TABLE `plat_com_cli_plat`
  ADD CONSTRAINT `FK_1vf7kfcn650557i0dvx7g5iwi` FOREIGN KEY (`plat_id`) REFERENCES `plat` (`id`),
  ADD CONSTRAINT `FK_6pkjgwojoqnl517hhwlhuvk11` FOREIGN KEY (`com_cli_plat_id`) REFERENCES `com_cli_plat` (`id`);
...
--
-- Contraintes pour la table `typereglement_reglement`
--
ALTER TABLE `typereglement_reglement`
  ADD CONSTRAINT `FK_4sy3o3idi53oq9ko7rvy6r1ri` FOREIGN KEY (`reglements_id`) REFERENCES `reglement` (`id`),
  ADD CONSTRAINT `FK_d4h4vqs3ylbgr4swr7d2s6bna` FOREIGN KEY (`typereglement_id`) REFERENCES `typereglement` (`id`);
...
--
-- Contraintes pour la table `utilisateur_com_cli_plat`
--
ALTER TABLE `utilisateur_com_cli_plat`
  ADD CONSTRAINT `FK_18dnmn86l6m0beubwp73bror2` FOREIGN KEY (`com_cli_plat_id`) REFERENCES `com_cli_plat` (`id`),
  ADD CONSTRAINT `FK_7q4i4ifdj8cqc91m8nfmdttgc` FOREIGN KEY (`Utilisateur_id`) REFERENCES `utilisateur` (`id`);

--
-- Contraintes pour la table `utilisateur_livraison`
--
ALTER TABLE `utilisateur_livraison`
  ADD CONSTRAINT `FK_mfs8qmnmbca0gltx57x3ltrev` FOREIGN KEY (`livraisons_id`) REFERENCES `livraison` (`id`),
  ADD CONSTRAINT `FK_ohj725lbbx4t6p3ar44by2s7c` FOREIGN KEY (`Utilisateur_id`) REFERENCES `utilisateur` (`id`);
